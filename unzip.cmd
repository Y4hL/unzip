...
:: Writes code into %notcalledaglobalvariable%\unzipper.ps1 ::
echo expand-archive -path '%zip%' -destinationpath '%dest%' -Force > %file_dir%\%notcalledaglobalvariable%\unzipper.ps1

:: Runs Unzipper ::
powershell.exe -File %file_dir%\%notcalledaglobalvariable%\unzipper.ps1

:: Deletes Temporary Files ::
del /F /Q %file_dir%\%notcalledaglobalvariable%\unzipper.ps1
